...
template<> inline PyTypeObject *SbkType< ::QGraphicsVideoItem >() { return SbkPySide6_QtMultimediaWidgetsTypes[SBK_QGRAPHICSVIDEOITEM_IDX]; }
template<> inline PyTypeObject *SbkType< ::QVideoWidget >() { return SbkPySide6_QtMultimediaWidgetsTypes[SBK_QVIDEOWIDGET_IDX]; }
