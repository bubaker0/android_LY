...
template<> inline PyTypeObject *SbkType< ::QMaskGenerator >() { return SbkPySide6_QtWebSocketsTypes[SBK_QMASKGENERATOR_IDX]; }
template<> inline PyTypeObject *SbkType< ::QWebSocket >() { return SbkPySide6_QtWebSocketsTypes[SBK_QWEBSOCKET_IDX]; }
template<> inline PyTypeObject *SbkType< ::QWebSocketCorsAuthenticator >() { return SbkPySide6_QtWebSocketsTypes[SBK_QWEBSOCKETCORSAUTHENTICATOR_IDX]; }
template<> inline PyTypeObject *SbkType< ::QWebSocketHandshakeOptions >() { return SbkPySide6_QtWebSocketsTypes[SBK_QWEBSOCKETHANDSHAKEOPTIONS_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QWebSocketServer >() { return SbkPySide6_QtWebSocketsTypes[SBK_QWEBSOCKETSERVER_IDX]; }
