...
template<> inline PyTypeObject *SbkType< ::QAbstractItemModelTester >() { return SbkPySide6_QtTestTypes[SBK_QABSTRACTITEMMODELTESTER_IDX]; }
template<> inline PyTypeObject *SbkType< ::QSignalSpy >() { return SbkPySide6_QtTestTypes[SBK_QSIGNALSPY_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QTest::PySideQTouchEventSequence >() { return SbkPySide6_QtTestTypes[SBK_QTEST_PYSIDEQTOUCHEVENTSEQUENCE_IDX]; }
