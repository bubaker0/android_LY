...
template<> inline PyTypeObject *SbkType< ::QAmbientSound >() { return SbkPySide6_QtSpatialAudioTypes[SBK_QAMBIENTSOUND_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QAudioEngine >() { return SbkPySide6_QtSpatialAudioTypes[SBK_QAUDIOENGINE_IDX]; }
template<> inline PyTypeObject *SbkType< ::QAudioListener >() { return SbkPySide6_QtSpatialAudioTypes[SBK_QAUDIOLISTENER_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QAudioRoom >() { return SbkPySide6_QtSpatialAudioTypes[SBK_QAUDIOROOM_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QSpatialSound >() { return SbkPySide6_QtSpatialAudioTypes[SBK_QSPATIALSOUND_IDX]; }
