...
#endif
template<> inline PyTypeObject *SbkType< ::QAbstractNetworkCache >() { return SbkPySide6_QtNetworkTypes[SBK_QABSTRACTNETWORKCACHE_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QAbstractSocket >() { return SbkPySide6_QtNetworkTypes[SBK_QABSTRACTSOCKET_IDX]; }
template<> inline PyTypeObject *SbkType< ::QAuthenticator >() { return SbkPySide6_QtNetworkTypes[SBK_QAUTHENTICATOR_IDX]; }
template<> inline PyTypeObject *SbkType< ::QDnsDomainNameRecord >() { return SbkPySide6_QtNetworkTypes[SBK_QDNSDOMAINNAMERECORD_IDX]; }
template<> inline PyTypeObject *SbkType< ::QDnsHostAddressRecord >() { return SbkPySide6_QtNetworkTypes[SBK_QDNSHOSTADDRESSRECORD_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QDnsLookup >() { return SbkPySide6_QtNetworkTypes[SBK_QDNSLOOKUP_IDX]; }
template<> inline PyTypeObject *SbkType< ::QDnsMailExchangeRecord >() { return SbkPySide6_QtNetworkTypes[SBK_QDNSMAILEXCHANGERECORD_IDX]; }
template<> inline PyTypeObject *SbkType< ::QDnsServiceRecord >() { return SbkPySide6_QtNetworkTypes[SBK_QDNSSERVICERECORD_IDX]; }
template<> inline PyTypeObject *SbkType< ::QDnsTextRecord >() { return SbkPySide6_QtNetworkTypes[SBK_QDNSTEXTRECORD_IDX]; }
#if QT_CONFIG(dtls)
template<> inline PyTypeObject *SbkType< ::QDtls::HandshakeState >() { return SbkPySide6_QtNetworkTypes[SBK_QDTLS_HANDSHAKESTATE_IDX]; }
template<> inline PyTypeObject *SbkType< ::QDtls >() { return SbkPySide6_QtNetworkTypes[SBK_QDTLS_IDX]; }
#endif
#if QT_CONFIG(dtls)
template<> inline PyTypeObject *SbkType< ::QDtlsClientVerifier >() { return SbkPySide6_QtNetworkTypes[SBK_QDTLSCLIENTVERIFIER_IDX]; }
#endif
...
template<> inline PyTypeObject *SbkType< ::QHostAddress >() { return SbkPySide6_QtNetworkTypes[SBK_QHOSTADDRESS_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QHostInfo >() { return SbkPySide6_QtNetworkTypes[SBK_QHOSTINFO_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QHstsPolicy >() { return SbkPySide6_QtNetworkTypes[SBK_QHSTSPOLICY_IDX]; }
template<> inline PyTypeObject *SbkType< ::QHttp2Configuration >() { return SbkPySide6_QtNetworkTypes[SBK_QHTTP2CONFIGURATION_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QHttpMultiPart >() { return SbkPySide6_QtNetworkTypes[SBK_QHTTPMULTIPART_IDX]; }
template<> inline PyTypeObject *SbkType< ::QHttpPart >() { return SbkPySide6_QtNetworkTypes[SBK_QHTTPPART_IDX]; }
template<> inline PyTypeObject *SbkType< ::QIPv6Address >() { return SbkPySide6_QtNetworkTypes[SBK_QIPV6ADDRESS_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QLocalServer >() { return SbkPySide6_QtNetworkTypes[SBK_QLOCALSERVER_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QLocalSocket >() { return SbkPySide6_QtNetworkTypes[SBK_QLOCALSOCKET_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QNetworkAccessManager >() { return SbkPySide6_QtNetworkTypes[SBK_QNETWORKACCESSMANAGER_IDX]; }
#ifndef QT_NO_NETWORKINTERFACE
...
template<> inline PyTypeObject *SbkType< ::QNetworkAddressEntry >() { return SbkPySide6_QtNetworkTypes[SBK_QNETWORKADDRESSENTRY_IDX]; }
#endif
template<> inline PyTypeObject *SbkType< ::QNetworkCacheMetaData >() { return SbkPySide6_QtNetworkTypes[SBK_QNETWORKCACHEMETADATA_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QNetworkCookie >() { return SbkPySide6_QtNetworkTypes[SBK_QNETWORKCOOKIE_IDX]; }
template<> inline PyTypeObject *SbkType< ::QNetworkCookieJar >() { return SbkPySide6_QtNetworkTypes[SBK_QNETWORKCOOKIEJAR_IDX]; }
template<> inline PyTypeObject *SbkType< ::QNetworkDatagram >() { return SbkPySide6_QtNetworkTypes[SBK_QNETWORKDATAGRAM_IDX]; }
template<> inline PyTypeObject *SbkType< ::QNetworkDiskCache >() { return SbkPySide6_QtNetworkTypes[SBK_QNETWORKDISKCACHE_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QNetworkInformation >() { return SbkPySide6_QtNetworkTypes[SBK_QNETWORKINFORMATION_IDX]; }
#ifndef QT_NO_NETWORKINTERFACE
...
template<> inline PyTypeObject *SbkType< ::QNetworkInterface >() { return SbkPySide6_QtNetworkTypes[SBK_QNETWORKINTERFACE_IDX]; }
#endif
...
template<> inline PyTypeObject *SbkType< ::QNetworkProxy >() { return SbkPySide6_QtNetworkTypes[SBK_QNETWORKPROXY_IDX]; }
template<> inline PyTypeObject *SbkType< ::QNetworkProxyFactory >() { return SbkPySide6_QtNetworkTypes[SBK_QNETWORKPROXYFACTORY_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QNetworkProxyQuery >() { return SbkPySide6_QtNetworkTypes[SBK_QNETWORKPROXYQUERY_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QNetworkReply >() { return SbkPySide6_QtNetworkTypes[SBK_QNETWORKREPLY_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QNetworkRequest >() { return SbkPySide6_QtNetworkTypes[SBK_QNETWORKREQUEST_IDX]; }
#if QT_CONFIG(ssl)
template<> inline PyTypeObject *SbkType< ::QOcspResponse >() { return SbkPySide6_QtNetworkTypes[SBK_QOCSPRESPONSE_IDX]; }
#endif
...
template<> inline PyTypeObject *SbkType< ::QSslCertificate >() { return SbkPySide6_QtNetworkTypes[SBK_QSSLCERTIFICATE_IDX]; }
#endif
#if QT_CONFIG(ssl)
template<> inline PyTypeObject *SbkType< ::QSslCertificateExtension >() { return SbkPySide6_QtNetworkTypes[SBK_QSSLCERTIFICATEEXTENSION_IDX]; }
#endif
#if QT_CONFIG(ssl)
template<> inline PyTypeObject *SbkType< ::QSslCipher >() { return SbkPySide6_QtNetworkTypes[SBK_QSSLCIPHER_IDX]; }
#endif
#if QT_CONFIG(ssl)
...
template<> inline PyTypeObject *SbkType< ::QSslConfiguration >() { return SbkPySide6_QtNetworkTypes[SBK_QSSLCONFIGURATION_IDX]; }
#endif
#if QT_CONFIG(ssl)
...
template<> inline PyTypeObject *SbkType< ::QSslDiffieHellmanParameters >() { return SbkPySide6_QtNetworkTypes[SBK_QSSLDIFFIEHELLMANPARAMETERS_IDX]; }
#endif
#if QT_CONFIG(ssl)
template<> inline PyTypeObject *SbkType< ::QSslEllipticCurve >() { return SbkPySide6_QtNetworkTypes[SBK_QSSLELLIPTICCURVE_IDX]; }
#endif
#if QT_CONFIG(ssl)
template<> inline PyTypeObject *SbkType< ::QSslError::SslError >() { return SbkPySide6_QtNetworkTypes[SBK_QSSLERROR_SSLERROR_IDX]; }
template<> inline PyTypeObject *SbkType< ::QSslError >() { return SbkPySide6_QtNetworkTypes[SBK_QSSLERROR_IDX]; }
#endif
template<> inline PyTypeObject *SbkType< ::QSslKey >() { return SbkPySide6_QtNetworkTypes[SBK_QSSLKEY_IDX]; }
#if QT_CONFIG(ssl)
template<> inline PyTypeObject *SbkType< ::QSslPreSharedKeyAuthenticator >() { return SbkPySide6_QtNetworkTypes[SBK_QSSLPRESHAREDKEYAUTHENTICATOR_IDX]; }
#endif
#if QT_CONFIG(ssl)
template<> inline PyTypeObject *SbkType< ::QSslServer >() { return SbkPySide6_QtNetworkTypes[SBK_QSSLSERVER_IDX]; }
#endif
#if QT_CONFIG(ssl)
...
template<> inline PyTypeObject *SbkType< ::QSslSocket >() { return SbkPySide6_QtNetworkTypes[SBK_QSSLSOCKET_IDX]; }
#endif
template<> inline PyTypeObject *SbkType< ::QTcpServer >() { return SbkPySide6_QtNetworkTypes[SBK_QTCPSERVER_IDX]; }
template<> inline PyTypeObject *SbkType< ::QTcpSocket >() { return SbkPySide6_QtNetworkTypes[SBK_QTCPSOCKET_IDX]; }
template<> inline PyTypeObject *SbkType< ::QUdpSocket >() { return SbkPySide6_QtNetworkTypes[SBK_QUDPSOCKET_IDX]; }
