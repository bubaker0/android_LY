...
template<> inline PyTypeObject *SbkType< ::Qt3DInput::QAbstractActionInput >() { return SbkPySide6_Qt3DInputTypes[SBK_QT3DINPUT_QABSTRACTACTIONINPUT_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DInput::QAbstractAxisInput >() { return SbkPySide6_Qt3DInputTypes[SBK_QT3DINPUT_QABSTRACTAXISINPUT_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DInput::QAbstractPhysicalDevice >() { return SbkPySide6_Qt3DInputTypes[SBK_QT3DINPUT_QABSTRACTPHYSICALDEVICE_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DInput::QAction >() { return SbkPySide6_Qt3DInputTypes[SBK_QT3DINPUT_QACTION_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DInput::QActionInput >() { return SbkPySide6_Qt3DInputTypes[SBK_QT3DINPUT_QACTIONINPUT_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DInput::QAnalogAxisInput >() { return SbkPySide6_Qt3DInputTypes[SBK_QT3DINPUT_QANALOGAXISINPUT_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DInput::QAxis >() { return SbkPySide6_Qt3DInputTypes[SBK_QT3DINPUT_QAXIS_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::Qt3DInput::QAxisAccumulator >() { return SbkPySide6_Qt3DInputTypes[SBK_QT3DINPUT_QAXISACCUMULATOR_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DInput::QAxisSetting >() { return SbkPySide6_Qt3DInputTypes[SBK_QT3DINPUT_QAXISSETTING_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DInput::QButtonAxisInput >() { return SbkPySide6_Qt3DInputTypes[SBK_QT3DINPUT_QBUTTONAXISINPUT_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DInput::QInputAspect >() { return SbkPySide6_Qt3DInputTypes[SBK_QT3DINPUT_QINPUTASPECT_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DInput::QInputChord >() { return SbkPySide6_Qt3DInputTypes[SBK_QT3DINPUT_QINPUTCHORD_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DInput::QInputSequence >() { return SbkPySide6_Qt3DInputTypes[SBK_QT3DINPUT_QINPUTSEQUENCE_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DInput::QInputSettings >() { return SbkPySide6_Qt3DInputTypes[SBK_QT3DINPUT_QINPUTSETTINGS_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DInput::QKeyEvent >() { return SbkPySide6_Qt3DInputTypes[SBK_QT3DINPUT_QKEYEVENT_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DInput::QKeyboardDevice >() { return SbkPySide6_Qt3DInputTypes[SBK_QT3DINPUT_QKEYBOARDDEVICE_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DInput::QKeyboardHandler >() { return SbkPySide6_Qt3DInputTypes[SBK_QT3DINPUT_QKEYBOARDHANDLER_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DInput::QLogicalDevice >() { return SbkPySide6_Qt3DInputTypes[SBK_QT3DINPUT_QLOGICALDEVICE_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::Qt3DInput::QMouseDevice >() { return SbkPySide6_Qt3DInputTypes[SBK_QT3DINPUT_QMOUSEDEVICE_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::Qt3DInput::QMouseEvent >() { return SbkPySide6_Qt3DInputTypes[SBK_QT3DINPUT_QMOUSEEVENT_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DInput::QMouseHandler >() { return SbkPySide6_Qt3DInputTypes[SBK_QT3DINPUT_QMOUSEHANDLER_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::Qt3DInput::QWheelEvent >() { return SbkPySide6_Qt3DInputTypes[SBK_QT3DINPUT_QWHEELEVENT_IDX]; }
