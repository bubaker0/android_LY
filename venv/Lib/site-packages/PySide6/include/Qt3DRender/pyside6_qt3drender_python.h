...
template<> inline PyTypeObject *SbkType< ::Qt3DRender::PropertyReaderInterface >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_PROPERTYREADERINTERFACE_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QAbstractLight >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QABSTRACTLIGHT_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QAbstractRayCaster >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QABSTRACTRAYCASTER_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QAbstractTexture >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QABSTRACTTEXTURE_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QAbstractTextureImage >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QABSTRACTTEXTUREIMAGE_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QAlphaCoverage >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QALPHACOVERAGE_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QAlphaTest >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QALPHATEST_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QBlendEquation >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QBLENDEQUATION_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QBlendEquationArguments >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QBLENDEQUATIONARGUMENTS_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QBlitFramebuffer >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QBLITFRAMEBUFFER_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QBufferCapture >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QBUFFERCAPTURE_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QCamera >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QCAMERA_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QCameraLens >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QCAMERALENS_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QCameraSelector >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QCAMERASELECTOR_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QClearBuffers >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QCLEARBUFFERS_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QClipPlane >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QCLIPPLANE_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QColorMask >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QCOLORMASK_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QComputeCommand >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QCOMPUTECOMMAND_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QCullFace >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QCULLFACE_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QDepthRange >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QDEPTHRANGE_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QDepthTest >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QDEPTHTEST_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QDirectionalLight >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QDIRECTIONALLIGHT_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QDispatchCompute >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QDISPATCHCOMPUTE_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QDithering >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QDITHERING_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QEffect >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QEFFECT_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QEnvironmentLight >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QENVIRONMENTLIGHT_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QFilterKey >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QFILTERKEY_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QFrameGraphNode >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QFRAMEGRAPHNODE_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QFrontFace >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QFRONTFACE_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QFrustumCulling >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QFRUSTUMCULLING_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QGeometryRenderer >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QGEOMETRYRENDERER_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QGraphicsApiFilter >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QGRAPHICSAPIFILTER_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QLayer >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QLAYER_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QLayerFilter >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QLAYERFILTER_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QLevelOfDetail >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QLEVELOFDETAIL_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QLevelOfDetailBoundingSphere >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QLEVELOFDETAILBOUNDINGSPHERE_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QLevelOfDetailSwitch >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QLEVELOFDETAILSWITCH_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QLineWidth >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QLINEWIDTH_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QMaterial >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QMATERIAL_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QMemoryBarrier >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QMEMORYBARRIER_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QMesh >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QMESH_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QMultiSampleAntiAliasing >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QMULTISAMPLEANTIALIASING_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QNoDepthMask >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QNODEPTHMASK_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QNoDraw >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QNODRAW_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QNoPicking >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QNOPICKING_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QObjectPicker >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QOBJECTPICKER_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QPaintedTextureImage >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QPAINTEDTEXTUREIMAGE_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QParameter >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QPARAMETER_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QPickEvent >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QPICKEVENT_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QPickLineEvent >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QPICKLINEEVENT_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QPickPointEvent >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QPICKPOINTEVENT_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QPickTriangleEvent >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QPICKTRIANGLEEVENT_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QPickingProxy >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QPICKINGPROXY_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QPickingSettings >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QPICKINGSETTINGS_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QPointLight >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QPOINTLIGHT_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QPointSize >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QPOINTSIZE_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QPolygonOffset >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QPOLYGONOFFSET_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QProximityFilter >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QPROXIMITYFILTER_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QRasterMode >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QRASTERMODE_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QRayCaster >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QRAYCASTER_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QRayCasterHit >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QRAYCASTERHIT_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QRenderAspect >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QRENDERASPECT_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QRenderCapabilities >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QRENDERCAPABILITIES_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QRenderCapture >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QRENDERCAPTURE_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QRenderCaptureReply >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QRENDERCAPTUREREPLY_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QRenderPass >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QRENDERPASS_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QRenderPassFilter >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QRENDERPASSFILTER_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QRenderSettings >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QRENDERSETTINGS_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QRenderState >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QRENDERSTATE_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QRenderStateSet >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QRENDERSTATESET_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QRenderSurfaceSelector >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QRENDERSURFACESELECTOR_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QRenderTarget >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QRENDERTARGET_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QRenderTargetOutput >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QRENDERTARGETOUTPUT_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QRenderTargetSelector >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QRENDERTARGETSELECTOR_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QSceneLoader >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QSCENELOADER_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QScissorTest >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QSCISSORTEST_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QScreenRayCaster >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QSCREENRAYCASTER_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QSeamlessCubemap >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QSEAMLESSCUBEMAP_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QSetFence >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QSETFENCE_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QShaderData >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QSHADERDATA_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QShaderImage >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QSHADERIMAGE_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QShaderProgram >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QSHADERPROGRAM_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QShaderProgramBuilder >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QSHADERPROGRAMBUILDER_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QSharedGLTexture >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QSHAREDGLTEXTURE_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QSortPolicy >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QSORTPOLICY_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QSpotLight >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QSPOTLIGHT_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QStencilMask >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QSTENCILMASK_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QStencilOperation >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QSTENCILOPERATION_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QStencilOperationArguments >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QSTENCILOPERATIONARGUMENTS_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QStencilTest >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QSTENCILTEST_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QStencilTestArguments >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QSTENCILTESTARGUMENTS_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QSubtreeEnabler >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QSUBTREEENABLER_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QTechnique >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QTECHNIQUE_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QTechniqueFilter >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QTECHNIQUEFILTER_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QTexture1D >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QTEXTURE1D_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QTexture1DArray >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QTEXTURE1DARRAY_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QTexture2D >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QTEXTURE2D_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QTexture2DArray >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QTEXTURE2DARRAY_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QTexture2DMultisample >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QTEXTURE2DMULTISAMPLE_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QTexture2DMultisampleArray >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QTEXTURE2DMULTISAMPLEARRAY_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QTexture3D >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QTEXTURE3D_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QTextureBuffer >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QTEXTUREBUFFER_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QTextureCubeMap >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QTEXTURECUBEMAP_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QTextureCubeMapArray >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QTEXTURECUBEMAPARRAY_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QTextureData >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QTEXTUREDATA_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QTextureDataUpdate >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QTEXTUREDATAUPDATE_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QTextureImage >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QTEXTUREIMAGE_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QTextureImageData >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QTEXTUREIMAGEDATA_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QTextureImageDataGenerator >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QTEXTUREIMAGEDATAGENERATOR_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QTextureLoader >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QTEXTURELOADER_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QTextureRectangle >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QTEXTURERECTANGLE_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QTextureWrapMode >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QTEXTUREWRAPMODE_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QViewport >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QVIEWPORT_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::Qt3DRender::QWaitFence >() { return SbkPySide6_Qt3DRenderTypes[SBK_QT3DRENDER_QWAITFENCE_IDX]; }
