...
template<> inline PyTypeObject *SbkType< ::QAbstractPrintDialog >() { return SbkPySide6_QtPrintSupportTypes[SBK_QABSTRACTPRINTDIALOG_IDX]; }
template<> inline PyTypeObject *SbkType< ::QPageSetupDialog >() { return SbkPySide6_QtPrintSupportTypes[SBK_QPAGESETUPDIALOG_IDX]; }
template<> inline PyTypeObject *SbkType< ::QPrintDialog >() { return SbkPySide6_QtPrintSupportTypes[SBK_QPRINTDIALOG_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QPrintEngine >() { return SbkPySide6_QtPrintSupportTypes[SBK_QPRINTENGINE_IDX]; }
template<> inline PyTypeObject *SbkType< ::QPrintPreviewDialog >() { return SbkPySide6_QtPrintSupportTypes[SBK_QPRINTPREVIEWDIALOG_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QPrintPreviewWidget >() { return SbkPySide6_QtPrintSupportTypes[SBK_QPRINTPREVIEWWIDGET_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QPrinter >() { return SbkPySide6_QtPrintSupportTypes[SBK_QPRINTER_IDX]; }
template<> inline PyTypeObject *SbkType< ::QPrinterInfo >() { return SbkPySide6_QtPrintSupportTypes[SBK_QPRINTERINFO_IDX]; }
