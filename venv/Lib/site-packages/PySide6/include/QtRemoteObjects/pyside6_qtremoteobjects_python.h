...
template<> inline PyTypeObject *SbkType< ::QAbstractItemModelReplica >() { return SbkPySide6_QtRemoteObjectsTypes[SBK_QABSTRACTITEMMODELREPLICA_IDX]; }
template<> inline PyTypeObject *SbkType< ::QRemoteObjectAbstractPersistedStore >() { return SbkPySide6_QtRemoteObjectsTypes[SBK_QREMOTEOBJECTABSTRACTPERSISTEDSTORE_IDX]; }
template<> inline PyTypeObject *SbkType< ::QRemoteObjectDynamicReplica >() { return SbkPySide6_QtRemoteObjectsTypes[SBK_QREMOTEOBJECTDYNAMICREPLICA_IDX]; }
template<> inline PyTypeObject *SbkType< ::QRemoteObjectHost >() { return SbkPySide6_QtRemoteObjectsTypes[SBK_QREMOTEOBJECTHOST_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QRemoteObjectHostBase >() { return SbkPySide6_QtRemoteObjectsTypes[SBK_QREMOTEOBJECTHOSTBASE_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QRemoteObjectNode >() { return SbkPySide6_QtRemoteObjectsTypes[SBK_QREMOTEOBJECTNODE_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QRemoteObjectPendingCall >() { return SbkPySide6_QtRemoteObjectsTypes[SBK_QREMOTEOBJECTPENDINGCALL_IDX]; }
template<> inline PyTypeObject *SbkType< ::QRemoteObjectPendingCallWatcher >() { return SbkPySide6_QtRemoteObjectsTypes[SBK_QREMOTEOBJECTPENDINGCALLWATCHER_IDX]; }
template<> inline PyTypeObject *SbkType< ::QRemoteObjectRegistry >() { return SbkPySide6_QtRemoteObjectsTypes[SBK_QREMOTEOBJECTREGISTRY_IDX]; }
template<> inline PyTypeObject *SbkType< ::QRemoteObjectRegistryHost >() { return SbkPySide6_QtRemoteObjectsTypes[SBK_QREMOTEOBJECTREGISTRYHOST_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QRemoteObjectReplica >() { return SbkPySide6_QtRemoteObjectsTypes[SBK_QREMOTEOBJECTREPLICA_IDX]; }
template<> inline PyTypeObject *SbkType< ::QRemoteObjectSettingsStore >() { return SbkPySide6_QtRemoteObjectsTypes[SBK_QREMOTEOBJECTSETTINGSSTORE_IDX]; }
template<> inline PyTypeObject *SbkType< ::QRemoteObjectSourceLocationInfo >() { return SbkPySide6_QtRemoteObjectsTypes[SBK_QREMOTEOBJECTSOURCELOCATIONINFO_IDX]; }
