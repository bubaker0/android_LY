...
template<> inline PyTypeObject *SbkType< ::QCanBus >() { return SbkPySide6_QtSerialBusTypes[SBK_QCANBUS_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QCanBusDevice >() { return SbkPySide6_QtSerialBusTypes[SBK_QCANBUSDEVICE_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QCanBusDevice::Filter >() { return SbkPySide6_QtSerialBusTypes[SBK_QCANBUSDEVICE_FILTER_IDX]; }
template<> inline PyTypeObject *SbkType< ::QCanBusDeviceInfo >() { return SbkPySide6_QtSerialBusTypes[SBK_QCANBUSDEVICEINFO_IDX]; }
template<> inline PyTypeObject *SbkType< ::QCanBusFactory >() { return SbkPySide6_QtSerialBusTypes[SBK_QCANBUSFACTORY_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QCanBusFrame >() { return SbkPySide6_QtSerialBusTypes[SBK_QCANBUSFRAME_IDX]; }
template<> inline PyTypeObject *SbkType< ::QCanBusFrame::TimeStamp >() { return SbkPySide6_QtSerialBusTypes[SBK_QCANBUSFRAME_TIMESTAMP_IDX]; }
template<> inline PyTypeObject *SbkType< ::QModbusClient >() { return SbkPySide6_QtSerialBusTypes[SBK_QMODBUSCLIENT_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QModbusDataUnit >() { return SbkPySide6_QtSerialBusTypes[SBK_QMODBUSDATAUNIT_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QModbusDevice >() { return SbkPySide6_QtSerialBusTypes[SBK_QMODBUSDEVICE_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QModbusDeviceIdentification >() { return SbkPySide6_QtSerialBusTypes[SBK_QMODBUSDEVICEIDENTIFICATION_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QModbusPdu >() { return SbkPySide6_QtSerialBusTypes[SBK_QMODBUSPDU_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QModbusReply >() { return SbkPySide6_QtSerialBusTypes[SBK_QMODBUSREPLY_IDX]; }
template<> inline PyTypeObject *SbkType< ::QModbusRequest >() { return SbkPySide6_QtSerialBusTypes[SBK_QMODBUSREQUEST_IDX]; }
template<> inline PyTypeObject *SbkType< ::QModbusRtuSerialClient >() { return SbkPySide6_QtSerialBusTypes[SBK_QMODBUSRTUSERIALCLIENT_IDX]; }
template<> inline PyTypeObject *SbkType< ::QModbusRtuSerialServer >() { return SbkPySide6_QtSerialBusTypes[SBK_QMODBUSRTUSERIALSERVER_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QModbusServer >() { return SbkPySide6_QtSerialBusTypes[SBK_QMODBUSSERVER_IDX]; }
template<> inline PyTypeObject *SbkType< ::QModbusTcpClient >() { return SbkPySide6_QtSerialBusTypes[SBK_QMODBUSTCPCLIENT_IDX]; }
template<> inline PyTypeObject *SbkType< ::QModbusTcpConnectionObserver >() { return SbkPySide6_QtSerialBusTypes[SBK_QMODBUSTCPCONNECTIONOBSERVER_IDX]; }
template<> inline PyTypeObject *SbkType< ::QModbusTcpServer >() { return SbkPySide6_QtSerialBusTypes[SBK_QMODBUSTCPSERVER_IDX]; }
