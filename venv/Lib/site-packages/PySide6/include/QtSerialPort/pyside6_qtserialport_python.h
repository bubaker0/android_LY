...
template<> inline PyTypeObject *SbkType< ::QSerialPort >() { return SbkPySide6_QtSerialPortTypes[SBK_QSERIALPORT_IDX]; }
template<> inline PyTypeObject *SbkType< ::QSerialPortInfo >() { return SbkPySide6_QtSerialPortTypes[SBK_QSERIALPORTINFO_IDX]; }
