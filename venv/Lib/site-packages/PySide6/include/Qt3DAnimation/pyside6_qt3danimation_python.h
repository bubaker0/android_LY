...
template<> inline PyTypeObject *SbkType< ::Qt3DAnimation::QAbstractAnimation >() { return SbkPySide6_Qt3DAnimationTypes[SBK_QT3DANIMATION_QABSTRACTANIMATION_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DAnimation::QAbstractAnimationClip >() { return SbkPySide6_Qt3DAnimationTypes[SBK_QT3DANIMATION_QABSTRACTANIMATIONCLIP_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DAnimation::QAbstractChannelMapping >() { return SbkPySide6_Qt3DAnimationTypes[SBK_QT3DANIMATION_QABSTRACTCHANNELMAPPING_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::Qt3DAnimation::QAbstractClipAnimator >() { return SbkPySide6_Qt3DAnimationTypes[SBK_QT3DANIMATION_QABSTRACTCLIPANIMATOR_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DAnimation::QAbstractClipBlendNode >() { return SbkPySide6_Qt3DAnimationTypes[SBK_QT3DANIMATION_QABSTRACTCLIPBLENDNODE_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DAnimation::QAdditiveClipBlend >() { return SbkPySide6_Qt3DAnimationTypes[SBK_QT3DANIMATION_QADDITIVECLIPBLEND_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DAnimation::QAnimationAspect >() { return SbkPySide6_Qt3DAnimationTypes[SBK_QT3DANIMATION_QANIMATIONASPECT_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::Qt3DAnimation::QAnimationCallback >() { return SbkPySide6_Qt3DAnimationTypes[SBK_QT3DANIMATION_QANIMATIONCALLBACK_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DAnimation::QAnimationClip >() { return SbkPySide6_Qt3DAnimationTypes[SBK_QT3DANIMATION_QANIMATIONCLIP_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DAnimation::QAnimationClipData >() { return SbkPySide6_Qt3DAnimationTypes[SBK_QT3DANIMATION_QANIMATIONCLIPDATA_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::Qt3DAnimation::QAnimationClipLoader >() { return SbkPySide6_Qt3DAnimationTypes[SBK_QT3DANIMATION_QANIMATIONCLIPLOADER_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DAnimation::QAnimationController >() { return SbkPySide6_Qt3DAnimationTypes[SBK_QT3DANIMATION_QANIMATIONCONTROLLER_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DAnimation::QAnimationGroup >() { return SbkPySide6_Qt3DAnimationTypes[SBK_QT3DANIMATION_QANIMATIONGROUP_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DAnimation::QBlendedClipAnimator >() { return SbkPySide6_Qt3DAnimationTypes[SBK_QT3DANIMATION_QBLENDEDCLIPANIMATOR_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DAnimation::QChannel >() { return SbkPySide6_Qt3DAnimationTypes[SBK_QT3DANIMATION_QCHANNEL_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DAnimation::QChannelComponent >() { return SbkPySide6_Qt3DAnimationTypes[SBK_QT3DANIMATION_QCHANNELCOMPONENT_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DAnimation::QChannelMapper >() { return SbkPySide6_Qt3DAnimationTypes[SBK_QT3DANIMATION_QCHANNELMAPPER_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DAnimation::QChannelMapping >() { return SbkPySide6_Qt3DAnimationTypes[SBK_QT3DANIMATION_QCHANNELMAPPING_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DAnimation::QClipAnimator >() { return SbkPySide6_Qt3DAnimationTypes[SBK_QT3DANIMATION_QCLIPANIMATOR_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DAnimation::QClipBlendValue >() { return SbkPySide6_Qt3DAnimationTypes[SBK_QT3DANIMATION_QCLIPBLENDVALUE_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DAnimation::QClock >() { return SbkPySide6_Qt3DAnimationTypes[SBK_QT3DANIMATION_QCLOCK_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::Qt3DAnimation::QKeyFrame >() { return SbkPySide6_Qt3DAnimationTypes[SBK_QT3DANIMATION_QKEYFRAME_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::Qt3DAnimation::QKeyframeAnimation >() { return SbkPySide6_Qt3DAnimationTypes[SBK_QT3DANIMATION_QKEYFRAMEANIMATION_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DAnimation::QLerpClipBlend >() { return SbkPySide6_Qt3DAnimationTypes[SBK_QT3DANIMATION_QLERPCLIPBLEND_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DAnimation::QMorphTarget >() { return SbkPySide6_Qt3DAnimationTypes[SBK_QT3DANIMATION_QMORPHTARGET_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::Qt3DAnimation::QMorphingAnimation >() { return SbkPySide6_Qt3DAnimationTypes[SBK_QT3DANIMATION_QMORPHINGANIMATION_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DAnimation::QSkeletonMapping >() { return SbkPySide6_Qt3DAnimationTypes[SBK_QT3DANIMATION_QSKELETONMAPPING_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DAnimation::QVertexBlendAnimation >() { return SbkPySide6_Qt3DAnimationTypes[SBK_QT3DANIMATION_QVERTEXBLENDANIMATION_IDX]; }
