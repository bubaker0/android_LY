...
template<> inline PyTypeObject *SbkType< ::Q3DBars >() { return SbkPySide6_QtDataVisualizationTypes[SBK_Q3DBARS_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::Q3DCamera >() { return SbkPySide6_QtDataVisualizationTypes[SBK_Q3DCAMERA_IDX]; }
template<> inline PyTypeObject *SbkType< ::Q3DInputHandler >() { return SbkPySide6_QtDataVisualizationTypes[SBK_Q3DINPUTHANDLER_IDX]; }
template<> inline PyTypeObject *SbkType< ::Q3DLight >() { return SbkPySide6_QtDataVisualizationTypes[SBK_Q3DLIGHT_IDX]; }
template<> inline PyTypeObject *SbkType< ::Q3DObject >() { return SbkPySide6_QtDataVisualizationTypes[SBK_Q3DOBJECT_IDX]; }
template<> inline PyTypeObject *SbkType< ::Q3DScatter >() { return SbkPySide6_QtDataVisualizationTypes[SBK_Q3DSCATTER_IDX]; }
template<> inline PyTypeObject *SbkType< ::Q3DScene >() { return SbkPySide6_QtDataVisualizationTypes[SBK_Q3DSCENE_IDX]; }
template<> inline PyTypeObject *SbkType< ::Q3DSurface >() { return SbkPySide6_QtDataVisualizationTypes[SBK_Q3DSURFACE_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::Q3DTheme >() { return SbkPySide6_QtDataVisualizationTypes[SBK_Q3DTHEME_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QAbstract3DAxis >() { return SbkPySide6_QtDataVisualizationTypes[SBK_QABSTRACT3DAXIS_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QAbstract3DGraph >() { return SbkPySide6_QtDataVisualizationTypes[SBK_QABSTRACT3DGRAPH_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QAbstract3DInputHandler >() { return SbkPySide6_QtDataVisualizationTypes[SBK_QABSTRACT3DINPUTHANDLER_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QAbstract3DSeries >() { return SbkPySide6_QtDataVisualizationTypes[SBK_QABSTRACT3DSERIES_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QAbstractDataProxy >() { return SbkPySide6_QtDataVisualizationTypes[SBK_QABSTRACTDATAPROXY_IDX]; }
template<> inline PyTypeObject *SbkType< ::QBar3DSeries >() { return SbkPySide6_QtDataVisualizationTypes[SBK_QBAR3DSERIES_IDX]; }
template<> inline PyTypeObject *SbkType< ::QBarDataItem >() { return SbkPySide6_QtDataVisualizationTypes[SBK_QBARDATAITEM_IDX]; }
template<> inline PyTypeObject *SbkType< ::QBarDataProxy >() { return SbkPySide6_QtDataVisualizationTypes[SBK_QBARDATAPROXY_IDX]; }
template<> inline PyTypeObject *SbkType< ::QCategory3DAxis >() { return SbkPySide6_QtDataVisualizationTypes[SBK_QCATEGORY3DAXIS_IDX]; }
template<> inline PyTypeObject *SbkType< ::QCustom3DItem >() { return SbkPySide6_QtDataVisualizationTypes[SBK_QCUSTOM3DITEM_IDX]; }
template<> inline PyTypeObject *SbkType< ::QCustom3DLabel >() { return SbkPySide6_QtDataVisualizationTypes[SBK_QCUSTOM3DLABEL_IDX]; }
template<> inline PyTypeObject *SbkType< ::QCustom3DVolume >() { return SbkPySide6_QtDataVisualizationTypes[SBK_QCUSTOM3DVOLUME_IDX]; }
template<> inline PyTypeObject *SbkType< ::QHeightMapSurfaceDataProxy >() { return SbkPySide6_QtDataVisualizationTypes[SBK_QHEIGHTMAPSURFACEDATAPROXY_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QItemModelBarDataProxy >() { return SbkPySide6_QtDataVisualizationTypes[SBK_QITEMMODELBARDATAPROXY_IDX]; }
template<> inline PyTypeObject *SbkType< ::QItemModelScatterDataProxy >() { return SbkPySide6_QtDataVisualizationTypes[SBK_QITEMMODELSCATTERDATAPROXY_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QItemModelSurfaceDataProxy >() { return SbkPySide6_QtDataVisualizationTypes[SBK_QITEMMODELSURFACEDATAPROXY_IDX]; }
template<> inline PyTypeObject *SbkType< ::QLogValue3DAxisFormatter >() { return SbkPySide6_QtDataVisualizationTypes[SBK_QLOGVALUE3DAXISFORMATTER_IDX]; }
template<> inline PyTypeObject *SbkType< ::QScatter3DSeries >() { return SbkPySide6_QtDataVisualizationTypes[SBK_QSCATTER3DSERIES_IDX]; }
template<> inline PyTypeObject *SbkType< ::QScatterDataItem >() { return SbkPySide6_QtDataVisualizationTypes[SBK_QSCATTERDATAITEM_IDX]; }
template<> inline PyTypeObject *SbkType< ::QScatterDataProxy >() { return SbkPySide6_QtDataVisualizationTypes[SBK_QSCATTERDATAPROXY_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QSurface3DSeries >() { return SbkPySide6_QtDataVisualizationTypes[SBK_QSURFACE3DSERIES_IDX]; }
template<> inline PyTypeObject *SbkType< ::QSurfaceDataItem >() { return SbkPySide6_QtDataVisualizationTypes[SBK_QSURFACEDATAITEM_IDX]; }
template<> inline PyTypeObject *SbkType< ::QSurfaceDataProxy >() { return SbkPySide6_QtDataVisualizationTypes[SBK_QSURFACEDATAPROXY_IDX]; }
template<> inline PyTypeObject *SbkType< ::QTouch3DInputHandler >() { return SbkPySide6_QtDataVisualizationTypes[SBK_QTOUCH3DINPUTHANDLER_IDX]; }
template<> inline PyTypeObject *SbkType< ::QValue3DAxis >() { return SbkPySide6_QtDataVisualizationTypes[SBK_QVALUE3DAXIS_IDX]; }
template<> inline PyTypeObject *SbkType< ::QValue3DAxisFormatter >() { return SbkPySide6_QtDataVisualizationTypes[SBK_QVALUE3DAXISFORMATTER_IDX]; }
