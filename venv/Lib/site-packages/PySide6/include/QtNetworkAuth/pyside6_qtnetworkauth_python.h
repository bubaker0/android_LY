...
template<> inline PyTypeObject *SbkType< ::QAbstractOAuth >() { return SbkPySide6_QtNetworkAuthTypes[SBK_QABSTRACTOAUTH_IDX]; }
template<> inline PyTypeObject *SbkType< ::QAbstractOAuth2 >() { return SbkPySide6_QtNetworkAuthTypes[SBK_QABSTRACTOAUTH2_IDX]; }
template<> inline PyTypeObject *SbkType< ::QAbstractOAuthReplyHandler >() { return SbkPySide6_QtNetworkAuthTypes[SBK_QABSTRACTOAUTHREPLYHANDLER_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QOAuth1 >() { return SbkPySide6_QtNetworkAuthTypes[SBK_QOAUTH1_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QOAuth1Signature >() { return SbkPySide6_QtNetworkAuthTypes[SBK_QOAUTH1SIGNATURE_IDX]; }
template<> inline PyTypeObject *SbkType< ::QOAuth2AuthorizationCodeFlow >() { return SbkPySide6_QtNetworkAuthTypes[SBK_QOAUTH2AUTHORIZATIONCODEFLOW_IDX]; }
template<> inline PyTypeObject *SbkType< ::QOAuthHttpServerReplyHandler >() { return SbkPySide6_QtNetworkAuthTypes[SBK_QOAUTHHTTPSERVERREPLYHANDLER_IDX]; }
template<> inline PyTypeObject *SbkType< ::QOAuthOobReplyHandler >() { return SbkPySide6_QtNetworkAuthTypes[SBK_QOAUTHOOBREPLYHANDLER_IDX]; }
