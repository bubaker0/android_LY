...
template<> inline PyTypeObject *SbkType< ::QWebChannel >() { return SbkPySide6_QtWebChannelTypes[SBK_QWEBCHANNEL_IDX]; }
template<> inline PyTypeObject *SbkType< ::QWebChannelAbstractTransport >() { return SbkPySide6_QtWebChannelTypes[SBK_QWEBCHANNELABSTRACTTRANSPORT_IDX]; }
