...
template<> inline PyTypeObject *SbkType< ::QJSEngine >() { return SbkPySide6_QtQmlTypes[SBK_QJSENGINE_IDX]; }
template<> inline PyTypeObject *SbkType< ::QJSManagedValue::Type >() { return SbkPySide6_QtQmlTypes[SBK_QJSMANAGEDVALUE_TYPE_IDX]; }
template<> inline PyTypeObject *SbkType< ::QJSManagedValue >() { return SbkPySide6_QtQmlTypes[SBK_QJSMANAGEDVALUE_IDX]; }
template<> inline PyTypeObject *SbkType< ::QJSPrimitiveValue::Type >() { return SbkPySide6_QtQmlTypes[SBK_QJSPRIMITIVEVALUE_TYPE_IDX]; }
template<> inline PyTypeObject *SbkType< ::QJSPrimitiveValue >() { return SbkPySide6_QtQmlTypes[SBK_QJSPRIMITIVEVALUE_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QJSValue >() { return SbkPySide6_QtQmlTypes[SBK_QJSVALUE_IDX]; }
template<> inline PyTypeObject *SbkType< ::QJSValueIterator >() { return SbkPySide6_QtQmlTypes[SBK_QJSVALUEITERATOR_IDX]; }
template<> inline PyTypeObject *SbkType< ::QPyQmlParserStatus >() { return SbkPySide6_QtQmlTypes[SBK_QPYQMLPARSERSTATUS_IDX]; }
template<> inline PyTypeObject *SbkType< ::QPyQmlPropertyValueSource >() { return SbkPySide6_QtQmlTypes[SBK_QPYQMLPROPERTYVALUESOURCE_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QQmlAbstractUrlInterceptor >() { return SbkPySide6_QtQmlTypes[SBK_QQMLABSTRACTURLINTERCEPTOR_IDX]; }
template<> inline PyTypeObject *SbkType< ::QQmlApplicationEngine >() { return SbkPySide6_QtQmlTypes[SBK_QQMLAPPLICATIONENGINE_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QQmlComponent >() { return SbkPySide6_QtQmlTypes[SBK_QQMLCOMPONENT_IDX]; }
template<> inline PyTypeObject *SbkType< ::QQmlContext >() { return SbkPySide6_QtQmlTypes[SBK_QQMLCONTEXT_IDX]; }
template<> inline PyTypeObject *SbkType< ::QQmlContext::PropertyPair >() { return SbkPySide6_QtQmlTypes[SBK_QQMLCONTEXT_PROPERTYPAIR_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QQmlDebuggingEnabler >() { return SbkPySide6_QtQmlTypes[SBK_QQMLDEBUGGINGENABLER_IDX]; }
template<> inline PyTypeObject *SbkType< ::QQmlEngine >() { return SbkPySide6_QtQmlTypes[SBK_QQMLENGINE_IDX]; }
template<> inline PyTypeObject *SbkType< ::QQmlError >() { return SbkPySide6_QtQmlTypes[SBK_QQMLERROR_IDX]; }
template<> inline PyTypeObject *SbkType< ::QQmlExpression >() { return SbkPySide6_QtQmlTypes[SBK_QQMLEXPRESSION_IDX]; }
template<> inline PyTypeObject *SbkType< ::QQmlExtensionInterface >() { return SbkPySide6_QtQmlTypes[SBK_QQMLEXTENSIONINTERFACE_IDX]; }
template<> inline PyTypeObject *SbkType< ::QQmlExtensionPlugin >() { return SbkPySide6_QtQmlTypes[SBK_QQMLEXTENSIONPLUGIN_IDX]; }
template<> inline PyTypeObject *SbkType< ::QQmlFile::Status >() { return SbkPySide6_QtQmlTypes[SBK_QQMLFILE_STATUS_IDX]; }
template<> inline PyTypeObject *SbkType< ::QQmlFile >() { return SbkPySide6_QtQmlTypes[SBK_QQMLFILE_IDX]; }
template<> inline PyTypeObject *SbkType< ::QQmlFileSelector >() { return SbkPySide6_QtQmlTypes[SBK_QQMLFILESELECTOR_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QQmlImageProviderBase >() { return SbkPySide6_QtQmlTypes[SBK_QQMLIMAGEPROVIDERBASE_IDX]; }
template<> inline PyTypeObject *SbkType< ::QQmlIncubationController >() { return SbkPySide6_QtQmlTypes[SBK_QQMLINCUBATIONCONTROLLER_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QQmlIncubator >() { return SbkPySide6_QtQmlTypes[SBK_QQMLINCUBATOR_IDX]; }
template<> inline PyTypeObject *SbkType< ::QQmlListReference >() { return SbkPySide6_QtQmlTypes[SBK_QQMLLISTREFERENCE_IDX]; }
template<> inline PyTypeObject *SbkType< ::QQmlNetworkAccessManagerFactory >() { return SbkPySide6_QtQmlTypes[SBK_QQMLNETWORKACCESSMANAGERFACTORY_IDX]; }
template<> inline PyTypeObject *SbkType< ::QQmlParserStatus >() { return SbkPySide6_QtQmlTypes[SBK_QQMLPARSERSTATUS_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QQmlProperty >() { return SbkPySide6_QtQmlTypes[SBK_QQMLPROPERTY_IDX]; }
template<> inline PyTypeObject *SbkType< ::QQmlPropertyMap >() { return SbkPySide6_QtQmlTypes[SBK_QQMLPROPERTYMAP_IDX]; }
template<> inline PyTypeObject *SbkType< ::QQmlPropertyValueSource >() { return SbkPySide6_QtQmlTypes[SBK_QQMLPROPERTYVALUESOURCE_IDX]; }
template<> inline PyTypeObject *SbkType< ::QQmlScriptString >() { return SbkPySide6_QtQmlTypes[SBK_QQMLSCRIPTSTRING_IDX]; }
template<> inline PyTypeObject *SbkType< ::QQmlTypesExtensionInterface >() { return SbkPySide6_QtQmlTypes[SBK_QQMLTYPESEXTENSIONINTERFACE_IDX]; }
