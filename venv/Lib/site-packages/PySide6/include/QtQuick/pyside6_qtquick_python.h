...
template<> inline PyTypeObject *SbkType< ::QQuickAsyncImageProvider >() { return SbkPySide6_QtQuickTypes[SBK_QQUICKASYNCIMAGEPROVIDER_IDX]; }
template<> inline PyTypeObject *SbkType< ::QQuickFramebufferObject >() { return SbkPySide6_QtQuickTypes[SBK_QQUICKFRAMEBUFFEROBJECT_IDX]; }
template<> inline PyTypeObject *SbkType< ::QQuickFramebufferObject::Renderer >() { return SbkPySide6_QtQuickTypes[SBK_QQUICKFRAMEBUFFEROBJECT_RENDERER_IDX]; }
template<> inline PyTypeObject *SbkType< ::QQuickGraphicsConfiguration >() { return SbkPySide6_QtQuickTypes[SBK_QQUICKGRAPHICSCONFIGURATION_IDX]; }
template<> inline PyTypeObject *SbkType< ::QQuickGraphicsDevice >() { return SbkPySide6_QtQuickTypes[SBK_QQUICKGRAPHICSDEVICE_IDX]; }
template<> inline PyTypeObject *SbkType< ::QQuickImageProvider >() { return SbkPySide6_QtQuickTypes[SBK_QQUICKIMAGEPROVIDER_IDX]; }
template<> inline PyTypeObject *SbkType< ::QQuickImageResponse >() { return SbkPySide6_QtQuickTypes[SBK_QQUICKIMAGERESPONSE_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QQuickItem >() { return SbkPySide6_QtQuickTypes[SBK_QQUICKITEM_IDX]; }
template<> inline PyTypeObject *SbkType< ::QQuickItem::UpdatePaintNodeData >() { return SbkPySide6_QtQuickTypes[SBK_QQUICKITEM_UPDATEPAINTNODEDATA_IDX]; }
template<> inline PyTypeObject *SbkType< ::QQuickItemGrabResult >() { return SbkPySide6_QtQuickTypes[SBK_QQUICKITEMGRABRESULT_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QQuickPaintedItem >() { return SbkPySide6_QtQuickTypes[SBK_QQUICKPAINTEDITEM_IDX]; }
template<> inline PyTypeObject *SbkType< ::QQuickRenderControl >() { return SbkPySide6_QtQuickTypes[SBK_QQUICKRENDERCONTROL_IDX]; }
template<> inline PyTypeObject *SbkType< ::QQuickRenderTarget >() { return SbkPySide6_QtQuickTypes[SBK_QQUICKRENDERTARGET_IDX]; }
template<> inline PyTypeObject *SbkType< ::QQuickTextDocument >() { return SbkPySide6_QtQuickTypes[SBK_QQUICKTEXTDOCUMENT_IDX]; }
template<> inline PyTypeObject *SbkType< ::QQuickTextureFactory >() { return SbkPySide6_QtQuickTypes[SBK_QQUICKTEXTUREFACTORY_IDX]; }
template<> inline PyTypeObject *SbkType< ::QQuickTransform >() { return SbkPySide6_QtQuickTypes[SBK_QQUICKTRANSFORM_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QQuickView >() { return SbkPySide6_QtQuickTypes[SBK_QQUICKVIEW_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QQuickWindow >() { return SbkPySide6_QtQuickTypes[SBK_QQUICKWINDOW_IDX]; }
template<> inline PyTypeObject *SbkType< ::QSGBasicGeometryNode >() { return SbkPySide6_QtQuickTypes[SBK_QSGBASICGEOMETRYNODE_IDX]; }
template<> inline PyTypeObject *SbkType< ::QSGClipNode >() { return SbkPySide6_QtQuickTypes[SBK_QSGCLIPNODE_IDX]; }
template<> inline PyTypeObject *SbkType< ::QSGDynamicTexture >() { return SbkPySide6_QtQuickTypes[SBK_QSGDYNAMICTEXTURE_IDX]; }
template<> inline PyTypeObject *SbkType< ::QSGFlatColorMaterial >() { return SbkPySide6_QtQuickTypes[SBK_QSGFLATCOLORMATERIAL_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QSGGeometry >() { return SbkPySide6_QtQuickTypes[SBK_QSGGEOMETRY_IDX]; }
template<> inline PyTypeObject *SbkType< ::QSGGeometry::Attribute >() { return SbkPySide6_QtQuickTypes[SBK_QSGGEOMETRY_ATTRIBUTE_IDX]; }
template<> inline PyTypeObject *SbkType< ::QSGGeometry::AttributeSet >() { return SbkPySide6_QtQuickTypes[SBK_QSGGEOMETRY_ATTRIBUTESET_IDX]; }
template<> inline PyTypeObject *SbkType< ::QSGGeometry::ColoredPoint2D >() { return SbkPySide6_QtQuickTypes[SBK_QSGGEOMETRY_COLOREDPOINT2D_IDX]; }
template<> inline PyTypeObject *SbkType< ::QSGGeometry::Point2D >() { return SbkPySide6_QtQuickTypes[SBK_QSGGEOMETRY_POINT2D_IDX]; }
template<> inline PyTypeObject *SbkType< ::QSGGeometry::TexturedPoint2D >() { return SbkPySide6_QtQuickTypes[SBK_QSGGEOMETRY_TEXTUREDPOINT2D_IDX]; }
template<> inline PyTypeObject *SbkType< ::QSGGeometryNode >() { return SbkPySide6_QtQuickTypes[SBK_QSGGEOMETRYNODE_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QSGMaterial >() { return SbkPySide6_QtQuickTypes[SBK_QSGMATERIAL_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QSGMaterialShader >() { return SbkPySide6_QtQuickTypes[SBK_QSGMATERIALSHADER_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QSGMaterialShader::RenderState >() { return SbkPySide6_QtQuickTypes[SBK_QSGMATERIALSHADER_RENDERSTATE_IDX]; }
template<> inline PyTypeObject *SbkType< ::QSGMaterialType >() { return SbkPySide6_QtQuickTypes[SBK_QSGMATERIALTYPE_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QSGNode >() { return SbkPySide6_QtQuickTypes[SBK_QSGNODE_IDX]; }
template<> inline PyTypeObject *SbkType< ::QSGOpacityNode >() { return SbkPySide6_QtQuickTypes[SBK_QSGOPACITYNODE_IDX]; }
template<> inline PyTypeObject *SbkType< ::QSGOpaqueTextureMaterial >() { return SbkPySide6_QtQuickTypes[SBK_QSGOPAQUETEXTUREMATERIAL_IDX]; }
template<> inline PyTypeObject *SbkType< ::QSGRectangleNode >() { return SbkPySide6_QtQuickTypes[SBK_QSGRECTANGLENODE_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QSGRenderNode >() { return SbkPySide6_QtQuickTypes[SBK_QSGRENDERNODE_IDX]; }
template<> inline PyTypeObject *SbkType< ::QSGRenderNode::RenderState >() { return SbkPySide6_QtQuickTypes[SBK_QSGRENDERNODE_RENDERSTATE_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QSGRendererInterface >() { return SbkPySide6_QtQuickTypes[SBK_QSGRENDERERINTERFACE_IDX]; }
template<> inline PyTypeObject *SbkType< ::QSGSimpleRectNode >() { return SbkPySide6_QtQuickTypes[SBK_QSGSIMPLERECTNODE_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QSGSimpleTextureNode >() { return SbkPySide6_QtQuickTypes[SBK_QSGSIMPLETEXTURENODE_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QSGTexture >() { return SbkPySide6_QtQuickTypes[SBK_QSGTEXTURE_IDX]; }
template<> inline PyTypeObject *SbkType< ::QSGTextureMaterial >() { return SbkPySide6_QtQuickTypes[SBK_QSGTEXTUREMATERIAL_IDX]; }
template<> inline PyTypeObject *SbkType< ::QSGTextureProvider >() { return SbkPySide6_QtQuickTypes[SBK_QSGTEXTUREPROVIDER_IDX]; }
template<> inline PyTypeObject *SbkType< ::QSGTransformNode >() { return SbkPySide6_QtQuickTypes[SBK_QSGTRANSFORMNODE_IDX]; }
template<> inline PyTypeObject *SbkType< ::QSGVertexColorMaterial >() { return SbkPySide6_QtQuickTypes[SBK_QSGVERTEXCOLORMATERIAL_IDX]; }
