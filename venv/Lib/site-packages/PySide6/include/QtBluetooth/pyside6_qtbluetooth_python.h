...
template<> inline PyTypeObject *SbkType< ::QBluetoothAddress >() { return SbkPySide6_QtBluetoothTypes[SBK_QBLUETOOTHADDRESS_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QBluetoothDeviceDiscoveryAgent >() { return SbkPySide6_QtBluetoothTypes[SBK_QBLUETOOTHDEVICEDISCOVERYAGENT_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QBluetoothDeviceInfo >() { return SbkPySide6_QtBluetoothTypes[SBK_QBLUETOOTHDEVICEINFO_IDX]; }
template<> inline PyTypeObject *SbkType< ::QBluetoothHostInfo >() { return SbkPySide6_QtBluetoothTypes[SBK_QBLUETOOTHHOSTINFO_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QBluetoothLocalDevice >() { return SbkPySide6_QtBluetoothTypes[SBK_QBLUETOOTHLOCALDEVICE_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QBluetoothServer >() { return SbkPySide6_QtBluetoothTypes[SBK_QBLUETOOTHSERVER_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QBluetoothServiceDiscoveryAgent >() { return SbkPySide6_QtBluetoothTypes[SBK_QBLUETOOTHSERVICEDISCOVERYAGENT_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QBluetoothServiceInfo >() { return SbkPySide6_QtBluetoothTypes[SBK_QBLUETOOTHSERVICEINFO_IDX]; }
template<> inline PyTypeObject *SbkType< ::QBluetoothServiceInfo::Alternative >() { return SbkPySide6_QtBluetoothTypes[SBK_QBLUETOOTHSERVICEINFO_ALTERNATIVE_IDX]; }
template<> inline PyTypeObject *SbkType< ::QBluetoothServiceInfo::Sequence >() { return SbkPySide6_QtBluetoothTypes[SBK_QBLUETOOTHSERVICEINFO_SEQUENCE_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QBluetoothSocket >() { return SbkPySide6_QtBluetoothTypes[SBK_QBLUETOOTHSOCKET_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QBluetoothUuid >() { return SbkPySide6_QtBluetoothTypes[SBK_QBLUETOOTHUUID_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QLowEnergyAdvertisingData >() { return SbkPySide6_QtBluetoothTypes[SBK_QLOWENERGYADVERTISINGDATA_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QLowEnergyAdvertisingParameters >() { return SbkPySide6_QtBluetoothTypes[SBK_QLOWENERGYADVERTISINGPARAMETERS_IDX]; }
template<> inline PyTypeObject *SbkType< ::QLowEnergyAdvertisingParameters::AddressInfo >() { return SbkPySide6_QtBluetoothTypes[SBK_QLOWENERGYADVERTISINGPARAMETERS_ADDRESSINFO_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QLowEnergyCharacteristic >() { return SbkPySide6_QtBluetoothTypes[SBK_QLOWENERGYCHARACTERISTIC_IDX]; }
template<> inline PyTypeObject *SbkType< ::QLowEnergyCharacteristicData >() { return SbkPySide6_QtBluetoothTypes[SBK_QLOWENERGYCHARACTERISTICDATA_IDX]; }
template<> inline PyTypeObject *SbkType< ::QLowEnergyConnectionParameters >() { return SbkPySide6_QtBluetoothTypes[SBK_QLOWENERGYCONNECTIONPARAMETERS_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QLowEnergyController >() { return SbkPySide6_QtBluetoothTypes[SBK_QLOWENERGYCONTROLLER_IDX]; }
template<> inline PyTypeObject *SbkType< ::QLowEnergyDescriptor >() { return SbkPySide6_QtBluetoothTypes[SBK_QLOWENERGYDESCRIPTOR_IDX]; }
template<> inline PyTypeObject *SbkType< ::QLowEnergyDescriptorData >() { return SbkPySide6_QtBluetoothTypes[SBK_QLOWENERGYDESCRIPTORDATA_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QLowEnergyService >() { return SbkPySide6_QtBluetoothTypes[SBK_QLOWENERGYSERVICE_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QLowEnergyServiceData >() { return SbkPySide6_QtBluetoothTypes[SBK_QLOWENERGYSERVICEDATA_IDX]; }
