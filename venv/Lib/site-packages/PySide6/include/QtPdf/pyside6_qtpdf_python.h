...
template<> inline PyTypeObject *SbkType< ::QPdfBookmarkModel >() { return SbkPySide6_QtPdfTypes[SBK_QPDFBOOKMARKMODEL_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QPdfDocument >() { return SbkPySide6_QtPdfTypes[SBK_QPDFDOCUMENT_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QPdfDocumentRenderOptions >() { return SbkPySide6_QtPdfTypes[SBK_QPDFDOCUMENTRENDEROPTIONS_IDX]; }
template<> inline PyTypeObject *SbkType< ::QPdfLink >() { return SbkPySide6_QtPdfTypes[SBK_QPDFLINK_IDX]; }
template<> inline PyTypeObject *SbkType< ::QPdfLinkModel::Role >() { return SbkPySide6_QtPdfTypes[SBK_QPDFLINKMODEL_ROLE_IDX]; }
template<> inline PyTypeObject *SbkType< ::QPdfLinkModel >() { return SbkPySide6_QtPdfTypes[SBK_QPDFLINKMODEL_IDX]; }
template<> inline PyTypeObject *SbkType< ::QPdfPageNavigator >() { return SbkPySide6_QtPdfTypes[SBK_QPDFPAGENAVIGATOR_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QPdfPageRenderer >() { return SbkPySide6_QtPdfTypes[SBK_QPDFPAGERENDERER_IDX]; }
template<> inline PyTypeObject *SbkType< ::QPdfSearchModel::Role >() { return SbkPySide6_QtPdfTypes[SBK_QPDFSEARCHMODEL_ROLE_IDX]; }
template<> inline PyTypeObject *SbkType< ::QPdfSearchModel >() { return SbkPySide6_QtPdfTypes[SBK_QPDFSEARCHMODEL_IDX]; }
template<> inline PyTypeObject *SbkType< ::QPdfSelection >() { return SbkPySide6_QtPdfTypes[SBK_QPDFSELECTION_IDX]; }
