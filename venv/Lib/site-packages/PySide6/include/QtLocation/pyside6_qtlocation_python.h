...
template<> inline PyTypeObject *SbkType< ::QGeoCodeReply >() { return SbkPySide6_QtLocationTypes[SBK_QGEOCODEREPLY_IDX]; }
template<> inline PyTypeObject *SbkType< ::QGeoCodingManager >() { return SbkPySide6_QtLocationTypes[SBK_QGEOCODINGMANAGER_IDX]; }
template<> inline PyTypeObject *SbkType< ::QGeoCodingManagerEngine >() { return SbkPySide6_QtLocationTypes[SBK_QGEOCODINGMANAGERENGINE_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QGeoManeuver >() { return SbkPySide6_QtLocationTypes[SBK_QGEOMANEUVER_IDX]; }
template<> inline PyTypeObject *SbkType< ::QGeoRoute >() { return SbkPySide6_QtLocationTypes[SBK_QGEOROUTE_IDX]; }
template<> inline PyTypeObject *SbkType< ::QGeoRouteReply::Error >() { return SbkPySide6_QtLocationTypes[SBK_QGEOROUTEREPLY_ERROR_IDX]; }
template<> inline PyTypeObject *SbkType< ::QGeoRouteReply >() { return SbkPySide6_QtLocationTypes[SBK_QGEOROUTEREPLY_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QGeoRouteRequest >() { return SbkPySide6_QtLocationTypes[SBK_QGEOROUTEREQUEST_IDX]; }
template<> inline PyTypeObject *SbkType< ::QGeoRouteSegment >() { return SbkPySide6_QtLocationTypes[SBK_QGEOROUTESEGMENT_IDX]; }
template<> inline PyTypeObject *SbkType< ::QGeoRoutingManager >() { return SbkPySide6_QtLocationTypes[SBK_QGEOROUTINGMANAGER_IDX]; }
template<> inline PyTypeObject *SbkType< ::QGeoRoutingManagerEngine >() { return SbkPySide6_QtLocationTypes[SBK_QGEOROUTINGMANAGERENGINE_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QGeoServiceProvider >() { return SbkPySide6_QtLocationTypes[SBK_QGEOSERVICEPROVIDER_IDX]; }
template<> inline PyTypeObject *SbkType< ::QGeoServiceProviderFactory >() { return SbkPySide6_QtLocationTypes[SBK_QGEOSERVICEPROVIDERFACTORY_IDX]; }
template<> inline PyTypeObject *SbkType< ::QPlace >() { return SbkPySide6_QtLocationTypes[SBK_QPLACE_IDX]; }
template<> inline PyTypeObject *SbkType< ::QPlaceAttribute >() { return SbkPySide6_QtLocationTypes[SBK_QPLACEATTRIBUTE_IDX]; }
template<> inline PyTypeObject *SbkType< ::QPlaceCategory >() { return SbkPySide6_QtLocationTypes[SBK_QPLACECATEGORY_IDX]; }
template<> inline PyTypeObject *SbkType< ::QPlaceContactDetail >() { return SbkPySide6_QtLocationTypes[SBK_QPLACECONTACTDETAIL_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QPlaceContent >() { return SbkPySide6_QtLocationTypes[SBK_QPLACECONTENT_IDX]; }
template<> inline PyTypeObject *SbkType< ::QPlaceContentReply >() { return SbkPySide6_QtLocationTypes[SBK_QPLACECONTENTREPLY_IDX]; }
template<> inline PyTypeObject *SbkType< ::QPlaceContentRequest >() { return SbkPySide6_QtLocationTypes[SBK_QPLACECONTENTREQUEST_IDX]; }
template<> inline PyTypeObject *SbkType< ::QPlaceDetailsReply >() { return SbkPySide6_QtLocationTypes[SBK_QPLACEDETAILSREPLY_IDX]; }
template<> inline PyTypeObject *SbkType< ::QPlaceIcon >() { return SbkPySide6_QtLocationTypes[SBK_QPLACEICON_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QPlaceIdReply >() { return SbkPySide6_QtLocationTypes[SBK_QPLACEIDREPLY_IDX]; }
template<> inline PyTypeObject *SbkType< ::QPlaceManager >() { return SbkPySide6_QtLocationTypes[SBK_QPLACEMANAGER_IDX]; }
template<> inline PyTypeObject *SbkType< ::QPlaceManagerEngine >() { return SbkPySide6_QtLocationTypes[SBK_QPLACEMANAGERENGINE_IDX]; }
template<> inline PyTypeObject *SbkType< ::QPlaceMatchReply >() { return SbkPySide6_QtLocationTypes[SBK_QPLACEMATCHREPLY_IDX]; }
template<> inline PyTypeObject *SbkType< ::QPlaceMatchRequest >() { return SbkPySide6_QtLocationTypes[SBK_QPLACEMATCHREQUEST_IDX]; }
template<> inline PyTypeObject *SbkType< ::QPlaceProposedSearchResult >() { return SbkPySide6_QtLocationTypes[SBK_QPLACEPROPOSEDSEARCHRESULT_IDX]; }
template<> inline PyTypeObject *SbkType< ::QPlaceRatings >() { return SbkPySide6_QtLocationTypes[SBK_QPLACERATINGS_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QPlaceReply >() { return SbkPySide6_QtLocationTypes[SBK_QPLACEREPLY_IDX]; }
template<> inline PyTypeObject *SbkType< ::QPlaceResult >() { return SbkPySide6_QtLocationTypes[SBK_QPLACERESULT_IDX]; }
template<> inline PyTypeObject *SbkType< ::QPlaceSearchReply >() { return SbkPySide6_QtLocationTypes[SBK_QPLACESEARCHREPLY_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QPlaceSearchRequest >() { return SbkPySide6_QtLocationTypes[SBK_QPLACESEARCHREQUEST_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QPlaceSearchResult >() { return SbkPySide6_QtLocationTypes[SBK_QPLACESEARCHRESULT_IDX]; }
template<> inline PyTypeObject *SbkType< ::QPlaceSearchSuggestionReply >() { return SbkPySide6_QtLocationTypes[SBK_QPLACESEARCHSUGGESTIONREPLY_IDX]; }
template<> inline PyTypeObject *SbkType< ::QPlaceSupplier >() { return SbkPySide6_QtLocationTypes[SBK_QPLACESUPPLIER_IDX]; }
template<> inline PyTypeObject *SbkType< ::QPlaceUser >() { return SbkPySide6_QtLocationTypes[SBK_QPLACEUSER_IDX]; }
