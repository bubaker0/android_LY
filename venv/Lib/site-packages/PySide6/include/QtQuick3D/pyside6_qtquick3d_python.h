...
template<> inline PyTypeObject *SbkType< ::QQuick3D >() { return SbkPySide6_QtQuick3DTypes[SBK_QQUICK3D_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QQuick3DGeometry >() { return SbkPySide6_QtQuick3DTypes[SBK_QQUICK3DGEOMETRY_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QQuick3DGeometry::Attribute >() { return SbkPySide6_QtQuick3DTypes[SBK_QQUICK3DGEOMETRY_ATTRIBUTE_IDX]; }
template<> inline PyTypeObject *SbkType< ::QQuick3DGeometry::TargetAttribute >() { return SbkPySide6_QtQuick3DTypes[SBK_QQUICK3DGEOMETRY_TARGETATTRIBUTE_IDX]; }
template<> inline PyTypeObject *SbkType< ::QQuick3DInstancing >() { return SbkPySide6_QtQuick3DTypes[SBK_QQUICK3DINSTANCING_IDX]; }
template<> inline PyTypeObject *SbkType< ::QQuick3DInstancing::InstanceTableEntry >() { return SbkPySide6_QtQuick3DTypes[SBK_QQUICK3DINSTANCING_INSTANCETABLEENTRY_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QQuick3DObject >() { return SbkPySide6_QtQuick3DTypes[SBK_QQUICK3DOBJECT_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QQuick3DTextureData >() { return SbkPySide6_QtQuick3DTypes[SBK_QQUICK3DTEXTUREDATA_IDX]; }
