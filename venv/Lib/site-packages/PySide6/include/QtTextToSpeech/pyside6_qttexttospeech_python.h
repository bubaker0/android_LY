...
template<> inline PyTypeObject *SbkType< ::QTextToSpeech >() { return SbkPySide6_QtTextToSpeechTypes[SBK_QTEXTTOSPEECH_IDX]; }
template<> inline PyTypeObject *SbkType< ::QTextToSpeechEngine >() { return SbkPySide6_QtTextToSpeechTypes[SBK_QTEXTTOSPEECHENGINE_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QVoice >() { return SbkPySide6_QtTextToSpeechTypes[SBK_QVOICE_IDX]; }
