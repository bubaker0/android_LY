...
template<> inline PyTypeObject *SbkType< ::QAbstractHttpServer >() { return SbkPySide6_QtHttpServerTypes[SBK_QABSTRACTHTTPSERVER_IDX]; }
#if QT_CONFIG(future)
template<> inline PyTypeObject *SbkType< ::QFutureHttpServerResponse >() { return SbkPySide6_QtHttpServerTypes[SBK_QFUTUREHTTPSERVERRESPONSE_IDX]; }
#endif
template<> inline PyTypeObject *SbkType< ::QHttpServer >() { return SbkPySide6_QtHttpServerTypes[SBK_QHTTPSERVER_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QHttpServerRequest >() { return SbkPySide6_QtHttpServerTypes[SBK_QHTTPSERVERREQUEST_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QHttpServerResponder >() { return SbkPySide6_QtHttpServerTypes[SBK_QHTTPSERVERRESPONDER_IDX]; }
template<> inline PyTypeObject *SbkType< ::QHttpServerResponse >() { return SbkPySide6_QtHttpServerTypes[SBK_QHTTPSERVERRESPONSE_IDX]; }
template<> inline PyTypeObject *SbkType< ::QHttpServerRouter >() { return SbkPySide6_QtHttpServerTypes[SBK_QHTTPSERVERROUTER_IDX]; }
template<> inline PyTypeObject *SbkType< ::QHttpServerRouterRule >() { return SbkPySide6_QtHttpServerTypes[SBK_QHTTPSERVERROUTERRULE_IDX]; }
