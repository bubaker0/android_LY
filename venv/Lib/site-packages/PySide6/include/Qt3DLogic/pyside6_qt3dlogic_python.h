...
template<> inline PyTypeObject *SbkType< ::Qt3DLogic::QFrameAction >() { return SbkPySide6_Qt3DLogicTypes[SBK_QT3DLOGIC_QFRAMEACTION_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DLogic::QLogicAspect >() { return SbkPySide6_Qt3DLogicTypes[SBK_QT3DLOGIC_QLOGICASPECT_IDX]; }
