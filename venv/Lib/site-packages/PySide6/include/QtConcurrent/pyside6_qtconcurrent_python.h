...
#if QT_CONFIG(future)
template<> inline PyTypeObject *SbkType< ::QFutureQString >() { return SbkPySide6_QtConcurrentTypes[SBK_QFUTUREQSTRING_IDX]; }
#endif
#if QT_CONFIG(future)
template<> inline PyTypeObject *SbkType< ::QFutureVoid >() { return SbkPySide6_QtConcurrentTypes[SBK_QFUTUREVOID_IDX]; }
#endif
#if QT_CONFIG(future)
template<> inline PyTypeObject *SbkType< ::QFutureWatcherQString >() { return SbkPySide6_QtConcurrentTypes[SBK_QFUTUREWATCHERQSTRING_IDX]; }
#endif
#if QT_CONFIG(future)
template<> inline PyTypeObject *SbkType< ::QFutureWatcherVoid >() { return SbkPySide6_QtConcurrentTypes[SBK_QFUTUREWATCHERVOID_IDX]; }
#endif
