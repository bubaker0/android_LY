...
template<> inline PyTypeObject *SbkType< ::QSvgGenerator >() { return SbkPySide6_QtSvgTypes[SBK_QSVGGENERATOR_IDX]; }
template<> inline PyTypeObject *SbkType< ::QSvgRenderer >() { return SbkPySide6_QtSvgTypes[SBK_QSVGRENDERER_IDX]; }
