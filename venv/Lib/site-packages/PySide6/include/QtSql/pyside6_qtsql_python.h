...
template<> inline PyTypeObject *SbkType< ::QSqlDatabase >() { return SbkPySide6_QtSqlTypes[SBK_QSQLDATABASE_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QSqlDriver >() { return SbkPySide6_QtSqlTypes[SBK_QSQLDRIVER_IDX]; }
template<> inline PyTypeObject *SbkType< ::QSqlDriverCreatorBase >() { return SbkPySide6_QtSqlTypes[SBK_QSQLDRIVERCREATORBASE_IDX]; }
template<> inline PyTypeObject *SbkType< ::QSqlError::ErrorType >() { return SbkPySide6_QtSqlTypes[SBK_QSQLERROR_ERRORTYPE_IDX]; }
template<> inline PyTypeObject *SbkType< ::QSqlError >() { return SbkPySide6_QtSqlTypes[SBK_QSQLERROR_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QSqlField >() { return SbkPySide6_QtSqlTypes[SBK_QSQLFIELD_IDX]; }
template<> inline PyTypeObject *SbkType< ::QSqlIndex >() { return SbkPySide6_QtSqlTypes[SBK_QSQLINDEX_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QSqlQuery >() { return SbkPySide6_QtSqlTypes[SBK_QSQLQUERY_IDX]; }
template<> inline PyTypeObject *SbkType< ::QSqlQueryModel >() { return SbkPySide6_QtSqlTypes[SBK_QSQLQUERYMODEL_IDX]; }
template<> inline PyTypeObject *SbkType< ::QSqlRecord >() { return SbkPySide6_QtSqlTypes[SBK_QSQLRECORD_IDX]; }
template<> inline PyTypeObject *SbkType< ::QSqlRelation >() { return SbkPySide6_QtSqlTypes[SBK_QSQLRELATION_IDX]; }
template<> inline PyTypeObject *SbkType< ::QSqlRelationalDelegate >() { return SbkPySide6_QtSqlTypes[SBK_QSQLRELATIONALDELEGATE_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QSqlRelationalTableModel >() { return SbkPySide6_QtSqlTypes[SBK_QSQLRELATIONALTABLEMODEL_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QSqlResult >() { return SbkPySide6_QtSqlTypes[SBK_QSQLRESULT_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QSqlTableModel >() { return SbkPySide6_QtSqlTypes[SBK_QSQLTABLEMODEL_IDX]; }
