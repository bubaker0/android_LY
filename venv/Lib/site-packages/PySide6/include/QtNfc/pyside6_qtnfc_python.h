...
template<> inline PyTypeObject *SbkType< ::QNdefFilter >() { return SbkPySide6_QtNfcTypes[SBK_QNDEFFILTER_IDX]; }
template<> inline PyTypeObject *SbkType< ::QNdefFilter::Record >() { return SbkPySide6_QtNfcTypes[SBK_QNDEFFILTER_RECORD_IDX]; }
template<> inline PyTypeObject *SbkType< ::QNdefMessage >() { return SbkPySide6_QtNfcTypes[SBK_QNDEFMESSAGE_IDX]; }
template<> inline PyTypeObject *SbkType< ::QNdefNfcIconRecord >() { return SbkPySide6_QtNfcTypes[SBK_QNDEFNFCICONRECORD_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QNdefNfcSmartPosterRecord >() { return SbkPySide6_QtNfcTypes[SBK_QNDEFNFCSMARTPOSTERRECORD_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QNdefNfcTextRecord >() { return SbkPySide6_QtNfcTypes[SBK_QNDEFNFCTEXTRECORD_IDX]; }
template<> inline PyTypeObject *SbkType< ::QNdefNfcUriRecord >() { return SbkPySide6_QtNfcTypes[SBK_QNDEFNFCURIRECORD_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QNdefRecord >() { return SbkPySide6_QtNfcTypes[SBK_QNDEFRECORD_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QNearFieldManager >() { return SbkPySide6_QtNfcTypes[SBK_QNEARFIELDMANAGER_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QNearFieldTarget >() { return SbkPySide6_QtNfcTypes[SBK_QNEARFIELDTARGET_IDX]; }
