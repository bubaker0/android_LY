...
template<> inline PyTypeObject *SbkType< ::QPdfPageSelector >() { return SbkPySide6_QtPdfWidgetsTypes[SBK_QPDFPAGESELECTOR_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QPdfView >() { return SbkPySide6_QtPdfWidgetsTypes[SBK_QPDFVIEW_IDX]; }
