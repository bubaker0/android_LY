...
template<> inline PyTypeObject *SbkType< ::QAudioBuffer >() { return SbkPySide6_QtMultimediaTypes[SBK_QAUDIOBUFFER_IDX]; }
template<> inline PyTypeObject *SbkType< ::QAudioDecoder::Error >() { return SbkPySide6_QtMultimediaTypes[SBK_QAUDIODECODER_ERROR_IDX]; }
template<> inline PyTypeObject *SbkType< ::QAudioDecoder >() { return SbkPySide6_QtMultimediaTypes[SBK_QAUDIODECODER_IDX]; }
template<> inline PyTypeObject *SbkType< ::QAudioDevice::Mode >() { return SbkPySide6_QtMultimediaTypes[SBK_QAUDIODEVICE_MODE_IDX]; }
template<> inline PyTypeObject *SbkType< ::QAudioDevice >() { return SbkPySide6_QtMultimediaTypes[SBK_QAUDIODEVICE_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QAudioFormat >() { return SbkPySide6_QtMultimediaTypes[SBK_QAUDIOFORMAT_IDX]; }
template<> inline PyTypeObject *SbkType< ::QAudioInput >() { return SbkPySide6_QtMultimediaTypes[SBK_QAUDIOINPUT_IDX]; }
template<> inline PyTypeObject *SbkType< ::QAudioOutput >() { return SbkPySide6_QtMultimediaTypes[SBK_QAUDIOOUTPUT_IDX]; }
template<> inline PyTypeObject *SbkType< ::QAudioSink >() { return SbkPySide6_QtMultimediaTypes[SBK_QAUDIOSINK_IDX]; }
template<> inline PyTypeObject *SbkType< ::QAudioSource >() { return SbkPySide6_QtMultimediaTypes[SBK_QAUDIOSOURCE_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QCamera >() { return SbkPySide6_QtMultimediaTypes[SBK_QCAMERA_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QCameraDevice >() { return SbkPySide6_QtMultimediaTypes[SBK_QCAMERADEVICE_IDX]; }
template<> inline PyTypeObject *SbkType< ::QCameraFormat >() { return SbkPySide6_QtMultimediaTypes[SBK_QCAMERAFORMAT_IDX]; }
template<> inline PyTypeObject *SbkType< ::QCapturableWindow >() { return SbkPySide6_QtMultimediaTypes[SBK_QCAPTURABLEWINDOW_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QImageCapture >() { return SbkPySide6_QtMultimediaTypes[SBK_QIMAGECAPTURE_IDX]; }
template<> inline PyTypeObject *SbkType< ::QMediaCaptureSession >() { return SbkPySide6_QtMultimediaTypes[SBK_QMEDIACAPTURESESSION_IDX]; }
template<> inline PyTypeObject *SbkType< ::QMediaDevices >() { return SbkPySide6_QtMultimediaTypes[SBK_QMEDIADEVICES_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QMediaFormat >() { return SbkPySide6_QtMultimediaTypes[SBK_QMEDIAFORMAT_IDX]; }
template<> inline PyTypeObject *SbkType< ::QMediaMetaData::Key >() { return SbkPySide6_QtMultimediaTypes[SBK_QMEDIAMETADATA_KEY_IDX]; }
template<> inline PyTypeObject *SbkType< ::QMediaMetaData >() { return SbkPySide6_QtMultimediaTypes[SBK_QMEDIAMETADATA_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QMediaPlayer >() { return SbkPySide6_QtMultimediaTypes[SBK_QMEDIAPLAYER_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QMediaRecorder >() { return SbkPySide6_QtMultimediaTypes[SBK_QMEDIARECORDER_IDX]; }
template<> inline PyTypeObject *SbkType< ::QMediaTimeRange >() { return SbkPySide6_QtMultimediaTypes[SBK_QMEDIATIMERANGE_IDX]; }
template<> inline PyTypeObject *SbkType< ::QMediaTimeRange::Interval >() { return SbkPySide6_QtMultimediaTypes[SBK_QMEDIATIMERANGE_INTERVAL_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QScreenCapture >() { return SbkPySide6_QtMultimediaTypes[SBK_QSCREENCAPTURE_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QSoundEffect >() { return SbkPySide6_QtMultimediaTypes[SBK_QSOUNDEFFECT_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QVideoFrame >() { return SbkPySide6_QtMultimediaTypes[SBK_QVIDEOFRAME_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QVideoFrameFormat >() { return SbkPySide6_QtMultimediaTypes[SBK_QVIDEOFRAMEFORMAT_IDX]; }
template<> inline PyTypeObject *SbkType< ::QVideoSink >() { return SbkPySide6_QtMultimediaTypes[SBK_QVIDEOSINK_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QWindowCapture >() { return SbkPySide6_QtMultimediaTypes[SBK_QWINDOWCAPTURE_IDX]; }
