...
template<> inline PyTypeObject *SbkType< ::QGraphicsSvgItem >() { return SbkPySide6_QtSvgWidgetsTypes[SBK_QGRAPHICSSVGITEM_IDX]; }
template<> inline PyTypeObject *SbkType< ::QSvgWidget >() { return SbkPySide6_QtSvgWidgetsTypes[SBK_QSVGWIDGET_IDX]; }
