...
template<> inline PyTypeObject *SbkType< ::QDBusAbstractAdaptor >() { return SbkPySide6_QtDBusTypes[SBK_QDBUSABSTRACTADAPTOR_IDX]; }
template<> inline PyTypeObject *SbkType< ::QDBusAbstractInterface >() { return SbkPySide6_QtDBusTypes[SBK_QDBUSABSTRACTINTERFACE_IDX]; }
template<> inline PyTypeObject *SbkType< ::QDBusAbstractInterfaceBase >() { return SbkPySide6_QtDBusTypes[SBK_QDBUSABSTRACTINTERFACEBASE_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QDBusArgument >() { return SbkPySide6_QtDBusTypes[SBK_QDBUSARGUMENT_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QDBusConnection >() { return SbkPySide6_QtDBusTypes[SBK_QDBUSCONNECTION_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QDBusConnectionInterface >() { return SbkPySide6_QtDBusTypes[SBK_QDBUSCONNECTIONINTERFACE_IDX]; }
template<> inline PyTypeObject *SbkType< ::QDBusContext >() { return SbkPySide6_QtDBusTypes[SBK_QDBUSCONTEXT_IDX]; }
template<> inline PyTypeObject *SbkType< ::QDBusError::ErrorType >() { return SbkPySide6_QtDBusTypes[SBK_QDBUSERROR_ERRORTYPE_IDX]; }
template<> inline PyTypeObject *SbkType< ::QDBusError >() { return SbkPySide6_QtDBusTypes[SBK_QDBUSERROR_IDX]; }
template<> inline PyTypeObject *SbkType< ::QDBusInterface >() { return SbkPySide6_QtDBusTypes[SBK_QDBUSINTERFACE_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QDBusMessage >() { return SbkPySide6_QtDBusTypes[SBK_QDBUSMESSAGE_IDX]; }
template<> inline PyTypeObject *SbkType< ::QDBusObjectPath >() { return SbkPySide6_QtDBusTypes[SBK_QDBUSOBJECTPATH_IDX]; }
template<> inline PyTypeObject *SbkType< ::QDBusPendingCall >() { return SbkPySide6_QtDBusTypes[SBK_QDBUSPENDINGCALL_IDX]; }
template<> inline PyTypeObject *SbkType< ::QDBusPendingCallWatcher >() { return SbkPySide6_QtDBusTypes[SBK_QDBUSPENDINGCALLWATCHER_IDX]; }
template<> inline PyTypeObject *SbkType< ::QDBusServer >() { return SbkPySide6_QtDBusTypes[SBK_QDBUSSERVER_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QDBusServiceWatcher >() { return SbkPySide6_QtDBusTypes[SBK_QDBUSSERVICEWATCHER_IDX]; }
template<> inline PyTypeObject *SbkType< ::QDBusSignature >() { return SbkPySide6_QtDBusTypes[SBK_QDBUSSIGNATURE_IDX]; }
template<> inline PyTypeObject *SbkType< ::QDBusUnixFileDescriptor >() { return SbkPySide6_QtDBusTypes[SBK_QDBUSUNIXFILEDESCRIPTOR_IDX]; }
template<> inline PyTypeObject *SbkType< ::QDBusVariant >() { return SbkPySide6_QtDBusTypes[SBK_QDBUSVARIANT_IDX]; }
template<> inline PyTypeObject *SbkType< ::QDBusVirtualObject >() { return SbkPySide6_QtDBusTypes[SBK_QDBUSVIRTUALOBJECT_IDX]; }
template<> inline PyTypeObject *SbkType< ::QtDBusHelper::QDBusReply >() { return SbkPySide6_QtDBusTypes[SBK_QTDBUSHELPER_QDBUSREPLY_IDX]; }
