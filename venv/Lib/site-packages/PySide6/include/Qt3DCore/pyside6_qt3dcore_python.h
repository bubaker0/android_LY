...
template<> inline PyTypeObject *SbkType< ::Qt3DCore::QAbstractAspect >() { return SbkPySide6_Qt3DCoreTypes[SBK_QT3DCORE_QABSTRACTASPECT_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DCore::QAbstractFunctor >() { return SbkPySide6_Qt3DCoreTypes[SBK_QT3DCORE_QABSTRACTFUNCTOR_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DCore::QAbstractSkeleton >() { return SbkPySide6_Qt3DCoreTypes[SBK_QT3DCORE_QABSTRACTSKELETON_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DCore::QArmature >() { return SbkPySide6_Qt3DCoreTypes[SBK_QT3DCORE_QARMATURE_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::Qt3DCore::QAspectEngine >() { return SbkPySide6_Qt3DCoreTypes[SBK_QT3DCORE_QASPECTENGINE_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DCore::QAspectJob >() { return SbkPySide6_Qt3DCoreTypes[SBK_QT3DCORE_QASPECTJOB_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::Qt3DCore::QAttribute >() { return SbkPySide6_Qt3DCoreTypes[SBK_QT3DCORE_QATTRIBUTE_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::Qt3DCore::QBackendNode >() { return SbkPySide6_Qt3DCoreTypes[SBK_QT3DCORE_QBACKENDNODE_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DCore::QBackendNodeMapper >() { return SbkPySide6_Qt3DCoreTypes[SBK_QT3DCORE_QBACKENDNODEMAPPER_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DCore::QBoundingVolume >() { return SbkPySide6_Qt3DCoreTypes[SBK_QT3DCORE_QBOUNDINGVOLUME_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::Qt3DCore::QBuffer >() { return SbkPySide6_Qt3DCoreTypes[SBK_QT3DCORE_QBUFFER_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DCore::QComponent >() { return SbkPySide6_Qt3DCoreTypes[SBK_QT3DCORE_QCOMPONENT_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DCore::QCoreSettings >() { return SbkPySide6_Qt3DCoreTypes[SBK_QT3DCORE_QCORESETTINGS_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DCore::QEntity >() { return SbkPySide6_Qt3DCoreTypes[SBK_QT3DCORE_QENTITY_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DCore::QGeometry >() { return SbkPySide6_Qt3DCoreTypes[SBK_QT3DCORE_QGEOMETRY_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::Qt3DCore::QGeometryView >() { return SbkPySide6_Qt3DCoreTypes[SBK_QT3DCORE_QGEOMETRYVIEW_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DCore::QJoint >() { return SbkPySide6_Qt3DCoreTypes[SBK_QT3DCORE_QJOINT_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DCore::QNode >() { return SbkPySide6_Qt3DCoreTypes[SBK_QT3DCORE_QNODE_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DCore::QNodeId >() { return SbkPySide6_Qt3DCoreTypes[SBK_QT3DCORE_QNODEID_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DCore::QNodeIdTypePair >() { return SbkPySide6_Qt3DCoreTypes[SBK_QT3DCORE_QNODEIDTYPEPAIR_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DCore::QSkeleton >() { return SbkPySide6_Qt3DCoreTypes[SBK_QT3DCORE_QSKELETON_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::Qt3DCore::QSkeletonLoader >() { return SbkPySide6_Qt3DCoreTypes[SBK_QT3DCORE_QSKELETONLOADER_IDX]; }
template<> inline PyTypeObject *SbkType< ::Qt3DCore::QTransform >() { return SbkPySide6_Qt3DCoreTypes[SBK_QT3DCORE_QTRANSFORM_IDX]; }
