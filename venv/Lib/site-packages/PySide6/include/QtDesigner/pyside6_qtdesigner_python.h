...
template<> inline PyTypeObject *SbkType< ::QAbstractExtensionFactory >() { return SbkPySide6_QtDesignerTypes[SBK_QABSTRACTEXTENSIONFACTORY_IDX]; }
template<> inline PyTypeObject *SbkType< ::QAbstractExtensionManager >() { return SbkPySide6_QtDesignerTypes[SBK_QABSTRACTEXTENSIONMANAGER_IDX]; }
template<> inline PyTypeObject *SbkType< ::QAbstractFormBuilder >() { return SbkPySide6_QtDesignerTypes[SBK_QABSTRACTFORMBUILDER_IDX]; }
template<> inline PyTypeObject *SbkType< ::QDesignerActionEditorInterface >() { return SbkPySide6_QtDesignerTypes[SBK_QDESIGNERACTIONEDITORINTERFACE_IDX]; }
template<> inline PyTypeObject *SbkType< ::QDesignerContainerExtension >() { return SbkPySide6_QtDesignerTypes[SBK_QDESIGNERCONTAINEREXTENSION_IDX]; }
template<> inline PyTypeObject *SbkType< ::QDesignerCustomWidgetCollectionInterface >() { return SbkPySide6_QtDesignerTypes[SBK_QDESIGNERCUSTOMWIDGETCOLLECTIONINTERFACE_IDX]; }
template<> inline PyTypeObject *SbkType< ::QDesignerCustomWidgetInterface >() { return SbkPySide6_QtDesignerTypes[SBK_QDESIGNERCUSTOMWIDGETINTERFACE_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QDesignerDnDItemInterface >() { return SbkPySide6_QtDesignerTypes[SBK_QDESIGNERDNDITEMINTERFACE_IDX]; }
template<> inline PyTypeObject *SbkType< ::QDesignerDynamicPropertySheetExtension >() { return SbkPySide6_QtDesignerTypes[SBK_QDESIGNERDYNAMICPROPERTYSHEETEXTENSION_IDX]; }
template<> inline PyTypeObject *SbkType< ::QDesignerFormEditorInterface >() { return SbkPySide6_QtDesignerTypes[SBK_QDESIGNERFORMEDITORINTERFACE_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QDesignerFormWindowCursorInterface >() { return SbkPySide6_QtDesignerTypes[SBK_QDESIGNERFORMWINDOWCURSORINTERFACE_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QDesignerFormWindowInterface >() { return SbkPySide6_QtDesignerTypes[SBK_QDESIGNERFORMWINDOWINTERFACE_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QDesignerFormWindowManagerInterface >() { return SbkPySide6_QtDesignerTypes[SBK_QDESIGNERFORMWINDOWMANAGERINTERFACE_IDX]; }
template<> inline PyTypeObject *SbkType< ::QDesignerFormWindowToolInterface >() { return SbkPySide6_QtDesignerTypes[SBK_QDESIGNERFORMWINDOWTOOLINTERFACE_IDX]; }
template<> inline PyTypeObject *SbkType< ::QDesignerMemberSheetExtension >() { return SbkPySide6_QtDesignerTypes[SBK_QDESIGNERMEMBERSHEETEXTENSION_IDX]; }
template<> inline PyTypeObject *SbkType< ::QDesignerObjectInspectorInterface >() { return SbkPySide6_QtDesignerTypes[SBK_QDESIGNEROBJECTINSPECTORINTERFACE_IDX]; }
template<> inline PyTypeObject *SbkType< ::QDesignerPropertyEditorInterface >() { return SbkPySide6_QtDesignerTypes[SBK_QDESIGNERPROPERTYEDITORINTERFACE_IDX]; }
template<> inline PyTypeObject *SbkType< ::QDesignerPropertySheetExtension >() { return SbkPySide6_QtDesignerTypes[SBK_QDESIGNERPROPERTYSHEETEXTENSION_IDX]; }
template<> inline PyTypeObject *SbkType< ::QDesignerTaskMenuExtension >() { return SbkPySide6_QtDesignerTypes[SBK_QDESIGNERTASKMENUEXTENSION_IDX]; }
template<> inline PyTypeObject *SbkType< ::QDesignerWidgetBoxInterface >() { return SbkPySide6_QtDesignerTypes[SBK_QDESIGNERWIDGETBOXINTERFACE_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QDesignerWidgetBoxInterface::Category >() { return SbkPySide6_QtDesignerTypes[SBK_QDESIGNERWIDGETBOXINTERFACE_CATEGORY_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QDesignerWidgetBoxInterface::Widget >() { return SbkPySide6_QtDesignerTypes[SBK_QDESIGNERWIDGETBOXINTERFACE_WIDGET_IDX]; }
template<> inline PyTypeObject *SbkType< ::QExtensionFactory >() { return SbkPySide6_QtDesignerTypes[SBK_QEXTENSIONFACTORY_IDX]; }
template<> inline PyTypeObject *SbkType< ::QExtensionManager >() { return SbkPySide6_QtDesignerTypes[SBK_QEXTENSIONMANAGER_IDX]; }
template<> inline PyTypeObject *SbkType< ::QFormBuilder >() { return SbkPySide6_QtDesignerTypes[SBK_QFORMBUILDER_IDX]; }
template<> inline PyTypeObject *SbkType< ::QPyDesignerContainerExtension >() { return SbkPySide6_QtDesignerTypes[SBK_QPYDESIGNERCONTAINEREXTENSION_IDX]; }
template<> inline PyTypeObject *SbkType< ::QPyDesignerCustomWidgetCollection >() { return SbkPySide6_QtDesignerTypes[SBK_QPYDESIGNERCUSTOMWIDGETCOLLECTION_IDX]; }
template<> inline PyTypeObject *SbkType< ::QPyDesignerMemberSheetExtension >() { return SbkPySide6_QtDesignerTypes[SBK_QPYDESIGNERMEMBERSHEETEXTENSION_IDX]; }
template<> inline PyTypeObject *SbkType< ::QPyDesignerPropertySheetExtension >() { return SbkPySide6_QtDesignerTypes[SBK_QPYDESIGNERPROPERTYSHEETEXTENSION_IDX]; }
template<> inline PyTypeObject *SbkType< ::QPyDesignerTaskMenuExtension >() { return SbkPySide6_QtDesignerTypes[SBK_QPYDESIGNERTASKMENUEXTENSION_IDX]; }
