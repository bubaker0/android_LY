...
template<> inline PyTypeObject *SbkType< ::QAxBase >() { return SbkPySide6_QtAxContainerTypes[SBK_QAXBASE_IDX]; }
template<> inline PyTypeObject *SbkType< ::QAxBaseObject >() { return SbkPySide6_QtAxContainerTypes[SBK_QAXBASEOBJECT_IDX]; }
template<> inline PyTypeObject *SbkType< ::QAxBaseWidget >() { return SbkPySide6_QtAxContainerTypes[SBK_QAXBASEWIDGET_IDX]; }
template<> inline PyTypeObject *SbkType< ::QAxObject >() { return SbkPySide6_QtAxContainerTypes[SBK_QAXOBJECT_IDX]; }
template<> inline PyTypeObject *SbkType< ::QAxObjectInterface >() { return SbkPySide6_QtAxContainerTypes[SBK_QAXOBJECTINTERFACE_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QAxScript >() { return SbkPySide6_QtAxContainerTypes[SBK_QAXSCRIPT_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QAxScriptEngine >() { return SbkPySide6_QtAxContainerTypes[SBK_QAXSCRIPTENGINE_IDX]; }
template<> inline PyTypeObject *SbkType< ::QAxScriptManager >() { return SbkPySide6_QtAxContainerTypes[SBK_QAXSCRIPTMANAGER_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QAxSelect >() { return SbkPySide6_QtAxContainerTypes[SBK_QAXSELECT_IDX]; }
template<> inline PyTypeObject *SbkType< ::QAxWidget >() { return SbkPySide6_QtAxContainerTypes[SBK_QAXWIDGET_IDX]; }
