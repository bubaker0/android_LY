...
template<> inline PyTypeObject *SbkType< ::QAbstractState >() { return SbkPySide6_QtStateMachineTypes[SBK_QABSTRACTSTATE_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QAbstractTransition >() { return SbkPySide6_QtStateMachineTypes[SBK_QABSTRACTTRANSITION_IDX]; }
template<> inline PyTypeObject *SbkType< ::QEventTransition >() { return SbkPySide6_QtStateMachineTypes[SBK_QEVENTTRANSITION_IDX]; }
template<> inline PyTypeObject *SbkType< ::QFinalState >() { return SbkPySide6_QtStateMachineTypes[SBK_QFINALSTATE_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QHistoryState >() { return SbkPySide6_QtStateMachineTypes[SBK_QHISTORYSTATE_IDX]; }
template<> inline PyTypeObject *SbkType< ::QKeyEventTransition >() { return SbkPySide6_QtStateMachineTypes[SBK_QKEYEVENTTRANSITION_IDX]; }
template<> inline PyTypeObject *SbkType< ::QMouseEventTransition >() { return SbkPySide6_QtStateMachineTypes[SBK_QMOUSEEVENTTRANSITION_IDX]; }
template<> inline PyTypeObject *SbkType< ::QSignalTransition >() { return SbkPySide6_QtStateMachineTypes[SBK_QSIGNALTRANSITION_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QState >() { return SbkPySide6_QtStateMachineTypes[SBK_QSTATE_IDX]; }
...
template<> inline PyTypeObject *SbkType< ::QStateMachine >() { return SbkPySide6_QtStateMachineTypes[SBK_QSTATEMACHINE_IDX]; }
template<> inline PyTypeObject *SbkType< ::QStateMachine::SignalEvent >() { return SbkPySide6_QtStateMachineTypes[SBK_QSTATEMACHINE_SIGNALEVENT_IDX]; }
template<> inline PyTypeObject *SbkType< ::QStateMachine::WrappedEvent >() { return SbkPySide6_QtStateMachineTypes[SBK_QSTATEMACHINE_WRAPPEDEVENT_IDX]; }
